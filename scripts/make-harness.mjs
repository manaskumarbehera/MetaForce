  ...
  <div id="mf-panel">
    ...
    <div id="mf-tab-alldata" class="mf-tabpane">
      ...
      <div class="mf-ad-toolbar">
        ...
        <div class="mf-ad-actions"><button class="mf-ad-export-btn">Copy JSON</button><button class="mf-ad-export-btn">CSV</button><button class="mf-ad-export-btn">Copy SOQL</button></div>
      </div>
